...
export const EmailVerification = ({
  ...
  const previewText = "Centsy - Verify your email address";
        ...
        >
          ...
          <Container className="mx-auto my-[40px] max-w-[465px] rounded-md border border-solid border-[#eaeaea] p-[20px]">
            <Section>
              ...
              />
              <Img
                src="https://centsy.vercel.app/icon(black).png"
                width="40"
                height="40"
                alt="Centsy Logo"
            ...
            <Heading className="mx-0 my-[10px] p-0 text-center text-[24px] font-normal text-black">
              Verify your <strong>Centsy</strong> account
            </Heading>
            <Text className="text-[14px] leading-[24px] text-black">
              Hey {username}!
            </Text>
            <Text className="text-[14px] leading-[24px] text-black">
              Thank you for signing up for <strong>Centsy</strong>. To complete
              your registration, please verify your email address. This assists
              us in keeping your account safe.
            </Text>
            <Text className="text-[14px] leading-[24px] text-black">
            ...
            <Text className={`text-[${colors.mutedText}] text-center text-xs`}>
              If you didn&apos;t sign up for Centsy using{" "}
...
EmailVerification.PreviewProps = {
  ...
  username: "test",
  verificationLink: "https://centsy.com",
