...
export const EmailChangeConfirmation = ({
  ...
  const previewText = "Centsy - Confirm your email address change";
      ...
      <Tailwind>
        ...
        >
          ...
          <Container className="mx-auto my-[40px] max-w-[465px] rounded-md border border-solid border-[#eaeaea] p-[20px]">
            ...
            <Text className="text-[14px] leading-[24px] text-black">
              We received a request to change your email address for your Centsy
              account from <strong>{userEmail}</strong> to{" "}
            ...
            <Text className={`text-[${colors.mutedText}] text-center text-xs`}>
              ...
              <strong>Centsy</strong> account, please ignore this email or
...
EmailChangeConfirmation.PreviewProps = {
  ...
  username: "User",
  confirmationLink: "https://centsy.com",
