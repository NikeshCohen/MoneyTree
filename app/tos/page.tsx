...
export const metadata: Metadata = {
  ...
  description: "Terms of Service and Privacy Policy for Centsy.",
};
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground">
                By using Centsy, you agree to these Terms of Service. If you do
            ...
            <div>
              ...
              <ul className="text-muted-foreground list-disc space-y-2 pl-6">
                <li>Centsy may update or modify the platform at any time.</li>
                <li>
